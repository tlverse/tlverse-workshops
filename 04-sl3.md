...
runtime_sl_fit
   user  system elapsed 
302.770   1.851 304.532 
```

It took 304.5 seconds, 5.1 minutes, to fit the SL 
prediction function. 
...
<img src="04-sl3_files/figure-html/predobs-plot-1.png" alt="Observed and predicted values for weigh-for-height z-score (whz)" width="80%" />
<p class="caption">(\#fig:predobs-plot)Observed and predicted values for weigh-for-height z-score (whz)</p>
</div>
...
subsection](https://tlverse.org/tlverse-workshops/sl3.html#discrete-sl). Below, 
we show how to obtain a CV risk estimate for the SL using function `cv_sl`. 
Like before when we called `sl$train`, we will set a random number 
...
round(cv_sl_fit$coef, 3)
      fold Lrnr_glm_TRUE Lrnr_mean Lrnr_glmnet_NULL_deviance_10_0_100_TRUE
 [1,]    1         0.000         0                                   0.047
 [2,]    2         0.000         0                                   0.000
 [3,]    3         0.000         0                                   0.030
 [4,]    4         0.050         0                                   0.000
 ...
 [9,]    9         0.113         0                                   0.000
[10,]   10         0.000         0                                   0.000
      Lrnr_glmnet_NULL_deviance_10_1_100_TRUE Lrnr_polspline
 [1,]                                   0.000          0.243
 [2,]                                   0.257          0.161
 [3,]                                   0.000          0.079
 [4,]                                   0.459          0.000
 ...
 [9,]                                   0.103          0.106
[10,]                                   0.185          0.000
      Lrnr_earth_2_3_backward_0_1_0_0 Lrnr_hal9001_2_1_c(3, 2)_5
 [1,]                           0.253                      0.000
 [2,]                           0.000                      0.071
 [3,]                           0.175                      0.147
 [4,]                           0.111                      0.020
 ...
 [9,]                           0.129                      0.000
[10,]                           0.154                      0.000
      Lrnr_ranger_500_TRUE_none_1 Lrnr_xgboost_20_1 Lrnr_gam_NULL_NULL_GCV.Cp
 [1,]                       0.456             0.000                     0.000
 [2,]                       0.473             0.038                     0.000
 [3,]                       0.415             0.000                     0.154
 [4,]                       0.360             0.000                     0.000
...
Recall the object, `sl` defined in section 3.2:
...
6. an eSL that considered the same candidate learners as (1) and a 
   ranger meta-learner, using `lrn_ranger` which was instantiated in section 2;
