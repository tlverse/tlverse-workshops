...
knitr::include_graphics("img/png/tmle_sim/schematic_1_truedgd.png")
```
...
knitr::include_graphics("img/png/tmle_sim/schematic_2b_sllik.png")
```
...
knitr::include_graphics("img/png/tmle_sim/schematic_3_effects.png")
```
